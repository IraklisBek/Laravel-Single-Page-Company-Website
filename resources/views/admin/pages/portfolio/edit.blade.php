...
@section('content')
    ...
    <div class="portfolio-item col-md-3 col-sm-6">
        <div class="portfolio-thumb">
            <img id="blah" src="/visitor/images/gallery/{{$portfolio->background_image}}" alt="">
    ...
    <!--<button id="sameImage" class="btn btn-primary">Click Here</button> to use the same image-->

    {!! Form::model($portfolio, array('route' => ['portfolio.update', $portfolio->id], 'files' => true, 'method' => 'PUT')) !!}
    ...
    {!! Form::close() !!}
    <a href="{{ route('portfolio.index') }}" style="margin-left:3%;" class="btn btn-danger">Cancel</a>
    <br><br>
